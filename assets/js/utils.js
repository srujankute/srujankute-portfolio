...
const DEFAULT_DATA = {
    ...
    certifications: [
        { id: 1, title: "Data Visualization with PowerBI", issuer: "Coding Ninjas", date: "2026-05-01", desc: "The course covered the full development lifecycle, starting with the heavy lifting in Power Query—cleaning messy data, handling nulls, and setting up proper ETL pipelines. From there, I got into data modeling and writing custom DAX expressions to handle complex calculations and time-intelligence metrics. Finally, I worked on the front-end side, building clean, interactive dashboards that actually make data easy to read and act on.", link: "https://certificate.codingninjas.com/view/1313424ece38c03e" },
        { id: 2, title: "Data Analytics in Excel", issuer: "Coding Ninjas", date: "2025-11-01", desc: "The course provided a comprehensive introduction to data analysis using Excel, covering topics such as pivot tables, regression analysis, and data visualization techniques.", link: "https://certificate.codingninjas.com/view/72d90121ab513527" }
