...
const DEFAULT_DATA = {
    ...
    projects: [
        { id: 1, title: "Vehicle Order Sales Analysis", desc: "Global vehicle order volumes, revenue distribution, and supply chain performance dashboard built using Power BI.", tech: "PowerBI, DAX Functions, Power Query", link: "https://github.com/srujankute/Vahicle-Order-Sales-Analysis-PowerBI-Practice" }
    ],
    certifications: [
